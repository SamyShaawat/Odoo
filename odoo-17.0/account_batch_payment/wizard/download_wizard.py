...
class DownloadWizard(models.TransientModel):
    ...
    export_file = fields.Binary(string='File',  readonly=True, help="Generated XML file")
    export_filename = fields.Char(string='File name',  readonly=True, help="Name of the generated XML file")