odoo.define('commission_reports.commission_total_report', function (require) {
"use strict";
...
var CommissionTotalReport = AbstractAction.extend({
    hasControlPanel: true,

    events: {
        'click .js_report_commission_total_pdf': '_onPrintPdfBtnClicked',
        'click .js_report_commission_total_xlsx': '_onPrintXlsxBtnClicked',
    },
    ...
    renderButtons: function() {
        var self = this;
        this.$buttons = $(QWeb.render("commission_reports.commission_total_buttons", {}));
        return this.$buttons;
    },

    renderSearchViewButtons: function () {
        var self = this;
        this.$searchview_buttons = $(QWeb.render("commission_reports.commission_total_searchview_buttons", {options:this.kwargs}));
...
core.action_registry.add('commission_total_client', CommissionTotalReport);

return CommissionTotalReport;
