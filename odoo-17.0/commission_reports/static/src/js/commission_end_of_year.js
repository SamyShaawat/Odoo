odoo.define('commission_reports.commission_end_of_year_report', function (require) {
"use strict";
...
var CommissionEndOfYearReport = AbstractAction.extend({
    hasControlPanel: true,

    events: {
        'click .js_report_commission_end_of_year_pdf': '_onPrintPdfBtnClicked',
        'click .js_report_commission_end_of_year_xlsx': '_onPrintXlsxBtnClicked',
    },
    ...
    get_html: async function() {
        const { html, options } = await this._rpc({
            args: [this.kwargs],
            method: 'get_html',
            model: 'commission.endof.year.report',
        });
        console.log(options);
        this.html = html;
        this.kwargs = options;
    ...
    renderButtons: function() {
        var self = this;
        this.$buttons = $(QWeb.render("commission_reports.commission_end_of_year_buttons", {}));
        return this.$buttons;
    },

    renderSearchViewButtons: function () {
        var self = this;
        this.$searchview_buttons = $(QWeb.render("commission_reports.commission_end_of_year_searchview_buttons", {options:this.kwargs}));
    ...
    _onPrintPdfBtnClicked: function (){
        ...
        var vals = {
          ...
          "data": {
            "model": "commission.endof.year.report",
            "output_format": "pdf",
            "report_name": "commission_end_of_year",
...
core.action_registry.add('commission_end_of_year_client', CommissionEndOfYearReport);

return CommissionEndOfYearReport;
